...
SECRET_KEY = 'django-insecure-qz=%8g3@%inew%4+0gm@h=65kj7ghiahy7j8*2ll_z!3uc@7v6'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # Для JWT аутентификации
